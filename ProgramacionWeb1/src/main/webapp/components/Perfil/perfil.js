...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        type: 'GET',
        dataType: "json",
        url: "../../ObtenerUsuarioInfo"
    }).done(function (perfil, a, b) {
        console.log(perfil);
        ...
        $("#contrasenia").val(perfil.resultado.contraseña);
    }).fail(function (xr, lo) {
        console.log(xr);
    });
    ...
    $("#nombres").ready(function () {
        ...
        $("#formato-aviso-nombres").css({"color": "lightgreen"});
    ...
    $("#fecha-nacimiento").ready(function () {
        ...
        $("#formato-aviso-fecha-nacimiento").text("El formato coincide");
        banderaFecha = true;
    });
    ...
    $("#correo-electronico").ready(function () {
        ...
        $("#formato-aviso-correo").text("El formato coincide");
        banderaCorreo = true;
    });
    ...
    $("#nombre-usuario").ready(function () {
        ...
        $("#formato-aviso-usuario").text("El formato coincide");
        banderaUsuario = true;
    });
    ...
    $("#contrasenia").ready(function () {
        ...
        $("#formato-aviso-contrasenia").text("El formato coincide");

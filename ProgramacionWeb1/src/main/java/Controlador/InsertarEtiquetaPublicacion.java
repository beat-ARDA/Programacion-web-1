...
@WebServlet(name = "InsertarEtiquetaPublicacion", urlPatterns = {"/InsertarEtiquetaPublicacion"})
public class InsertarEtiquetaPublicacion extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (etiquetaPublicacionDao.insertEtiquetaPublicacion(etiquetaPublicacion)) {
